...
import static com.johncaboose.adventofcode.twentytwentyone.twentytwentyone.Utils.populateListWithCommaSeparatedLongs;

public class Day7 implements ISolvableDay {
    ...
    private static long fuelSpentToMoveTo(final long finalPosition, List<Long> initialPositions) {
        return fuelSpentToMoveTo(finalPosition, initialPositions, false);
    }
